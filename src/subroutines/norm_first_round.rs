...
fn test_norm_1_multiple_rows() {
    ...
    let witness_transposed: Vec<DPrimeRingElement> = vec![PrimeRing::random_short(), PrimeRing::random_short(), PrimeRing::random_short()];
...
fn test_norm_1() {
    let ck = CRS::gen_crs(3, 2).ck;
    let a = PrimeRing::random_short();
    let b = PrimeRing::random_short();
    let c = PrimeRing::random_short();

    let d = PrimeRing::random_short();
    let e = PrimeRing::random_short();
    let f = PrimeRing::random_short();
