use num_traits::One;
use rayon::prelude::*;
use crate::arithmetic::{add_matrices, compute_one_prefixed_power_series, first_n_columns, last_n_columns, parallel_dot_matrix_matrix, parallel_dot_series_matrix, PowerSeries, sample_random_mat};
...
pub fn norm_2(
    ...
    let challenge_one_zero_series = compute_one_prefixed_power_series(&PrimeRing::constant(0), witness.len());
...
mod tests_norm_2 {
    use super::*;
    use crate::arithmetic::{sample_random_mat, transpose, ring_inner_product, conjugate_vector, compose_with_radix, compose_with_radix_mod, sample_short_random_mat};
    use crate::prime_ring::r#static::MOD_Q;
    use crate::ntt::convolution::convolution;
    ...
    fn test_norm_2_inner_product() {
        ...
        let witness = sample_short_random_mat(nrows, ncols);
        ...
        assert_eq!(challenge * inverse_challenge.conjugate(), PrimeRing::constant(1));

        let (_, output_2) = norm_2(&ck, &new_witness, &challenge, &inverse_challenge);
