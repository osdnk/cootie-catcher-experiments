...
extern "C" uint64_t multiply_mod(uint64_t a, uint64_t b, uint64_t modulus) {
    return intel::hexl::MultiplyMod(a, b, modulus);
}

extern "C" uint64_t add_mod(uint64_t a, uint64_t b, uint64_t modulus) {
    return intel::hexl::AddUIntMod(a, b, modulus);
}

extern "C" uint64_t sub_mod(uint64_t a, uint64_t b, uint64_t modulus) {
    return intel::hexl::SubUIntMod(a, b, modulus);
}

extern "C" uint64_t power_mod(uint64_t a, uint64_t b, uint64_t modulus) {
    return intel::hexl::PowMod(a, b, modulus);
}

extern "C" void eltwise_mult_mod(uint64_t* result, const uint64_t* operand1, const uint64_t* operand2, uint64_t n, uint64_t modulus) {
    ...
    intel::hexl::EltwiseMultMod(result, op1.data(), op2.data(), n, modulus, 4);
}

extern "C" void multiply_poly(uint64_t* result, const uint64_t* operand1, const uint64_t* operand2, uint64_t n, uint64_t modulus) {
...
extern "C" void polynomial_multiply_cyclotomic_mod(
    uint64_t* result,
...
extern "C" void eltwise_reduce_mod(
    uint64_t* result,
...
extern "C" void ntt_forward_in_place(
    uint64_t* operand,
    size_t n,
    uint64_t modulus
) {
...
extern "C" void ntt_inverse_in_place(
    uint64_t* operand,
    size_t n,
    uint64_t modulus
) {
